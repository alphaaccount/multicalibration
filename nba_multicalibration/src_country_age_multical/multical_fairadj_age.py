...
def find_dp_ndcg(data, adj_mtx):
    ...
    embedding_np = np.genfromtxt('../../../../FairAdj/src/fairadj_nba_age.embedding', skip_header=0) 
      ...
      for j in range(11):
        for k in range(11):
          if data.iloc[i,2] == j+1 and data.iloc[i,5] == k+1:
            ...
            #if(11*j+k+4==112): print("The value of the fairscore is", b[i], brier[112], sizes[112])
