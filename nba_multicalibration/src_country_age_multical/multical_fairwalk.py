...
def find_dp_ndcg(data, adj_mtx):
    ...
    embedding_np = pk.load(open('nba_gat_entropy_0.01_800_uge-r_age_0.1.bin', 'rb'))
...
def find_dp_ndcg_all(data, adj_mtx):
    ...
    embedding_np = pk.load(open('nba_gat_entropy_0.01_800_uge-r_age_0.1_fairwalk.bin', 'rb'))
    #embedding_np = pk.load(open('nba_gat_entropy_0.01_800_uge-r_age_0.1.bin', 'rb'))
    sizes_edges = np.zeros(m, dtype=int)
    print(embedding_np.shape)
    sizes = np.zeros(m, dtype=int)
