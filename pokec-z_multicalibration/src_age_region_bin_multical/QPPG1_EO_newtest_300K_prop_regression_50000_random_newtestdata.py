    ...
    for alpha in Alpha:
      ...
      for indicator in indicator_all:
        ...
        for thr in Thr:
          ...
          FCE = nabla*avg_ECE + (1-nabla)*(max_ECE - min_ECE)
          ECE_t = nabla*ECE_t + (1-nabla)*(max_ECE_t - min_ECE_t)
          print("ECE scores of the groups fair are", ECE)
          print("Max ECE for the fair scores is", ECE.max())
          print("Delta ECE for the fair scores is", max_ECE-min_ECE)
          print("FCE for the fair scores is", FCE)
          print("t-ECE for the fair scores is", ECE_t)
