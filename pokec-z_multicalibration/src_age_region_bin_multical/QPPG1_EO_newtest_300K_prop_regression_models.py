...
def QPG_EO(data,adj_mtx, beta_avg, t):     #here we are taking two sensitive attrib # make the data here  
    ...
    #n = len(data_initial)
    M = adj_mtx.shape[0]
    print("This is for model ----", sys.argv[1])
    '''
    ...
    dataf1 = data.iloc[:10000]
    dataf2 = data.iloc[30000:70000]
    dataf3 = data.iloc[10000:30000]
    ...
    l = []
    b_old = []
    graph_embedding = pk.load(open("../../../../UGE/UGE-Unbiased-Graph-Embedding/embeddings/pokec-z_"+sys.argv[1]+"_entropy_0.01_800_embedding.bin", 'rb'))
