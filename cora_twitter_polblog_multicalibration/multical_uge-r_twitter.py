...
def find_dp_ndcg_all(data, adj_mtx):
    ...
    graph_embedding = pk.load(open("../../../UGE-Unbiased-Graph-Embedding/embeddings/twitter_gat_entropy_0.01_800_uge-r_opinion_0.1.bin",'rb'))
     #np.load("../../../FairEGM/results/cora/embeddings/gfo_d-32_d2-16_i-glorot_normal_i2-glorot_normal_19.npy")
