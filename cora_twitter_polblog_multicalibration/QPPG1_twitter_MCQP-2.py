...
#     report_index(index,data1,e):  
    ...
    for alpha in Alpha:
      ...
      for indicator in indicator_all:
        ...
        write_lists_to_file('y_prob_twitter_group_fair_MCQP-1_'+str(alpha)+'.txt',scores)
        write_lists_to_file('y_pred_twitter_group_fair_MCQP-1_'+str(alpha)+'.txt',convert_list_of_lists(scores))
