...
def find_dp_ndcg_all(data, adj_mtx):
    ...
    graph_embedding = pk.load(open('../../../DeBayes/cne_dump/pol-blog_seed_0_dim_8_trp_bias-deg.emb', 'rb'))
    ...
    train_array = np.loadtxt('../../../multicalibration_link_prediction/train_polblog.txt')
    test_array = np.loadtxt('../../../multicalibration_link_prediction/test_polblog.txt')
    val_array = np.loadtxt('../../../multicalibration_link_prediction/val_polblog.txt')

    predictions = np.loadtxt('../../../multicalibration_link_prediction/HKRR_polblog.txt', delimiter=',')
